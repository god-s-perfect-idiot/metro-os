...
| P1 | `MetroAppBar` ✅ | ApplicationBar — bottom, standard/minimized; `…` reveals icon labels + text overflow menu. Optional Store-style `MetroAppBarTextButton` primary row (outlined verbs). Apps needing bottom-bar options must use this, not a bespoke row. |
