...
| Page pivot swing | 200ms | Hinge `rotateY` 50° → 0° + fade, **no** X slide; closer camera (0.55× width). `MetroPagePivotSwing` — Start tile enter. `skipEnter` holds rest without disposing content |
