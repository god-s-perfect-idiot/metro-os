...
Agents must read this folder **before** changing UI in `apps/store/`.
...
```
Reference: apps/store/references/images/start_dark_blue.png
Guide: apps/store/references/web-resources.md#start-screen
```
