...
object ToastSpec {
    /** Accent strip: square icon + one message line. Clock lives in the status tray. */
    ...
    /**
     * Extra overlay height below the 52dp bar so a perspective `rotationX` trapezoid is not
