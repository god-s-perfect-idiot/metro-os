...
Agents must read this folder **before** changing UI in `apps/notes/`.
...
```
Reference: apps/notes/references/images/start_dark_blue.png
Guide: apps/notes/references/web-resources.md#start-screen
```
