# Mail — reference materials

Visual and behavioral source material for implementing this app to WP8.1 fidelity.

Agents must read this folder **before** changing UI in `apps/mail/`.
...
```
Reference: apps/mail/references/images/start_dark_blue.png
Guide: apps/mail/references/web-resources.md#start-screen
```
