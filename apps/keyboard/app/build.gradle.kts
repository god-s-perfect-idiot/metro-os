...
configure<ApplicationExtension> {
    ...
    defaultConfig {
        // metro-os package; FlorisBoard code package remains for engine stability
        applicationId = "com.metro.keyboard"
    ...
    buildTypes {
        named("debug") {
            // metro-os: keep applicationId as com.metro.keyboard (no .debug suffix)
            // so scripts/run-app.sh and the launcher resolve the same package.
