# Browser — reference materials

Visual and behavioral source material for implementing this app to WP8.1 fidelity.

Agents must read this folder **before** changing UI in `apps/browser/`.
...
```
Reference: apps/browser/references/images/start_dark_blue.png
Guide: apps/browser/references/web-resources.md#start-screen
```
