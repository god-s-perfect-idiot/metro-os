...
|------------------------|-------------|------------|
| Dedicated Hub panorama capture (dark + accent) | Brand `hub`, panes home / apps / featured, HubLinks + quick-link tiles + featured list | Use `images/panorama_dark_teal.png` (Music hub layout stand-in) + [`guides/blueprint.md`](guides/blueprint.md) |
