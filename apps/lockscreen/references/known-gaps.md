...
| Glance (always-on) screen | Minimal always-on time / notifications | Implemented via **Glance lockscreen** — black AMOLED chrome + quick-status; configured apps flip on new notification while locked |
