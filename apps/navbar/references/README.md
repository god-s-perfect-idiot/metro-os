# Navbar — reference materials

Visual and behavioral source material for implementing this app to WP8.1 fidelity.

Agents must read this folder **before** changing UI in `apps/navbar/`.
...
```
Reference: apps/navbar/references/images/start_dark_blue.png
Guide: apps/navbar/references/web-resources.md#start-screen
```
