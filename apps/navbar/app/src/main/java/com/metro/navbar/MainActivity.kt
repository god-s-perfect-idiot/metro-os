...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            var backgroundMode by remember { mutableStateOf(navbarPrefs.backgroundMode) }
                        ...
                        MetroListPicker(
                            ...
                            options = listOf(
                                MetroListPickerOption(
                                    ...
                                    stringResource(R.string.navbar_background_default_black),
                                ),
                                MetroListPickerOption(
                                    NavbarBackgroundMode.MatchAppBackground,
                                    stringResource(R.string.navbar_background_match_app),
                                ),
                                MetroListPickerOption(
                                    NavbarBackgroundMode.ShowAccentColor,
                                    stringResource(R.string.navbar_background_show_accent),
                                ),
                            ),
                            onSelectedChange = { mode ->
                                navbarPrefs.backgroundMode = mode
                                backgroundMode = navbarPrefs.backgroundMode
                                state.applyBackgroundModePreference()
                                NavbarOverlayService.requestBackgroundModeRefresh()
                            },
                            label = stringResource(R.string.navbar_background_label),
